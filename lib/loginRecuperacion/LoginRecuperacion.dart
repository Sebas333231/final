...
class LoginRecuperacionPage extends StatefulWidget {
  ...
  const LoginRecuperacionPage({Key? key, required this.themeManager}) : super(key: key);

  @override
  State<LoginRecuperacionPage> createState() => _LoginRecuperacionPageState(themeManager);
}

class _LoginRecuperacionPageState extends State<LoginRecuperacionPage> with SingleTickerProviderStateMixin {
            ...
            return Scaffold(
                body: Container(
                  ...
                  child: Container(
                    ...
                    child: LoginRecuperacion(themeManager: widget.themeManager,),
                  )
                )
            );
